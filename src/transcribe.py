...
def parse_args(args: Optional[List[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument("--model", type=str, default="small", choices=sorted(SUPPORTED_MODELS), help="Whisper model size")
    parser.add_argument("--output-formats", type=str, default="txt,srt,vtt,json", help="Comma-separated list of formats (txt, srt, vtt, json)")
